...
// ------------------
export const saveFrom = createAsyncThunk(
    `${namespace}/saveForm`,
    async ({ form, userId, theme }, thunkAPI) => {
...
export const initializeFormBeforeUpdate = createAsyncThunk(
    `${namespace}/initializeFormBeforeUpdate`,
    async ({ formId, theme }, thunkAPI) => {
        try {
...
export const selectFormDescription = (state, id) => {
    const form = state.form.forms.find((f) => f.Id === id);
    return !form ? markdownDefault : form.Description;
};
...
export const selectFromAuthorizedUsers = (state, id) => {
    const form = state.form.forms.find((f) => f.Id === id);
...
export const formSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder
            ...
            .addCase(initializeFormBeforeUpdate.fulfilled, (state, action) => {
                state.forms = [
                    ...state.forms,
                    {
            ...
            .addCase(initializeFormBeforeUpdate.rejected, () => {
                console.log("ERROR!!!!!!!!!!!!");
            });
    },
});
